...
export const storeProducts = [
    {
        ...
        checkoutUrl: "https://YOUR_HANDLE.gumroad.com/l/YOUR_PRODUCT",
        previewUrl: "",
        accent: "#65e8ff",
    },
    {
...
export const storeFaq = [
    ...
    },
    {
        ...
        answer:
            "No. These are educational organization tools and checklists. They do not replace legal, financial, medical or professional cybersecurity advice.",
    },
    {
        question: "Will these products guarantee a job or prevent every incident?",
        answer:
            "No. No template can guarantee employment, certification, income or complete security.",
    },
    {
        question: "Are certification exam questions included?",
        answer:
            "No. The products must contain original educational material and must not include stolen, confidential or copyrighted exam questions.",
    },
];
